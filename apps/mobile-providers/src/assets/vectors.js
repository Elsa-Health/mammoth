...
export const ElsaColorableIcon = React.memo(React.forwardRef((props, svgRef) => {
  return (
    <Svg
      width={24}
      height={24}
...
export const InformationIcon = React.memo(React.forwardRef((props, svgRef) => {
  return (
    <Svg
      width={24}
      height={24}
...
export const LibraryIcon = React.memo(React.forwardRef((props, svgRef) => {
  return (
    <Svg
      width={24}
      height={24}
...
export const PencilAltIcon = React.memo(React.forwardRef((props, svgRef) => {
  return (
    <Svg
      width={24}
      height={24}
...
export const ArrowDownIcon = React.memo(React.forwardRef((props, svgRef) => {
  return (
    <Svg
      width={24}
      height={24}
