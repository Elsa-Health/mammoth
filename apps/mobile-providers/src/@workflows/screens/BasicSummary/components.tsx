...
import {symptoms, useSymptomLocale} from '../../helpers/symptoms';
import {CheckCircleIcon} from '../../../@libs/elsa-ui/visuals/vectors';
              ...
              return {
                ...
                action: () => {
                  ...
                  if (presentAsPresent) {
                    ...
                    onSelectExistingSymptom &&
                      onSelectExistingSymptom(id as SymptomId, data);
                    return;
                  }
                  ...
                  if (presentAsAbsent) {
                    ...
                    onSelectExistingSymptom &&
                      onSelectExistingSymptom(id as SymptomId);
                    return;
                  }
  ...
  return (
    <View
      ...
      {Array(count)
        .fill(3)
        .map((x, ix) => (
          <View key={ix} style={{paddingLeft: ix !== 0 ? spacing : 0}}>
            <Circle size={size} />
          </View>
        ))}
