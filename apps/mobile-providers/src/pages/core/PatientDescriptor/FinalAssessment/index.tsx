...
export default function FinalAssessmentScreen () {
    ...
    const selected_conditions = usePatientDescription(s => s.elsa.computed, shallow)
    ...
    const setVals = usePatientDescription(s => 
        (dc: (data: Recommendations) => Recommendations) => 
            s.setDataChange(
                data => produce(data, df => {
    ...
    const selectedConditions = usePatientDescription(s => s.assessment.conditions, shallow)
    const setSelectedConditions = usePatientDescription(s => 
    ...
    return (
        <Layout navigation={navigation} title={t`title`} style={{ padding: 0, paddingTop: 0 }} hideLogo>
