...
import { Chip, chipStyles, RevealContent, SelectableChip } from '../../../../components/misc';
            ...
            <View style={{ paddingTop: 10 }}>
                ...
                <View style={{ display: 'flex', flexDirection: 'row', }}>
                    ...
                    <RevealContent show={symptom.present}>
                        ...
                        >
                            <Text style={{ color: theme.color.secondary.base }}>{"Expand"}</Text>
...
const SYMPTOMS_TO_START_WITH: SymptomId[] = ['fever', 'cough', 'dyspnoea', 'skin-rash', 'vomiting']
...
function MainView ({ route }) {
    ...
    return (
        <Layout title={"Presenting Complaints"} style={{ padding: 0 }} navigation={navigation} hideLogo>
            <View style={{ flex: 1, zIndex: 1 }}>
                <View style={{ flex: 1, paddingHorizontal: 24 }}>
                    {/* dummy search */}
                    <Pressable
                        onPress={() => navigation.navigate('symptom.view.search')}
                        style={{ 
                            width: '100%', 
                    ...
                    {/* body */}
                    {
                        symptoms.length !== 0 ? (
                            ...
                            <View style={{ paddingHorizontal: 0, flex: 1 }}>
                                ...
                                <View style={{ flex: 1, display: 'flex', flexDirection: 'row', flexWrap: 'wrap', marginVertical: 10 }}>
                                    {
...
function SymptomSelectable ({symptom}: { symptom: SymptomId}) {
...
export default function SymptomView () {
    return (
        <Stack.Navigator screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name="symptom.view.search" component={SymptomSearchView} />
        </Stack.Navigator>
    )
}
