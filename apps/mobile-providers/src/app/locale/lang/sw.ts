...
export default {
	...
	login: {
		...
		description:
			"Tafathali somesha kadi yako kwenye sehemu ya simu kwa hapo chini",
	},
	home: {
		greetings: {
			hi: "Salama",
	...
	settings: {
		...
		language: {
			title: "Badili lugha",
			description:
				"Badilisha lugha unayotaka itafsiriwe wenye kifaa chako",
		...
		logout: {
			title: "Ondoka",
			description:
				"Ondoka kwa muda kwenye kifaa mpaka pale utakapo rudi tena",
			action: "Ondoka sasa",
		},
	},
	assessment: {
		...
		intake: {
			...
			footer_note:
				"Bonyeza '$t(common.next)' ili kwenda kwenye uthamini wa mgonjwa",
		...
		summary: {
			signs_summary: {
				...
				no_symptoms_more:
					"Bonyeza hapo chini ilikuongeza ishara au dalili",
			},
			elsa_diagnosis: {
			...
			discard_dialog: {
				...
				description:
					"Unauhakika unataka kusitisha tathmini unayoishughulikia?",
				action: "Sitisha",
			},
		},
		search: {
			...
			search_notice:
				"Anza kwa kuandika ishara au dalili hapo chini au kuchangua mapendekezo ya Elsa",
			select_item:
				"Bonyeza ishara inayokaribiana na unachotafuta ili kuongoza mambo mengine juu ya hiyo",
		},
		manage: {
			...
			no_symptoms: {
				...
				description:
					"Ili kuongeza dalili za mgonjwa, bonyeza hapo juu na uanze kuandika",
			},
		},
		feedback: {
			err: {
				text_make_selection:
					"Kuna kosa. Lazima kuchangue utambuzi wako kabla ya kuendelea",
			},
			title: "Mapendekezo yako",
			condition_decision: {
				title: "Uchaguo wa hali yako",
				description:
					"Kwa hisia zako, ni hali gani zinazo msumbua mgonjwa?",
				component: {
			...
			next_steps: {
				...
				description:
					"Kulingana na hali inayowezekana hapo juu, unapaswa kuzingatia mapendekezo yafuatayo.",
				dispense_meds: "Toa dawa zifuatazo",
				recommend_tests: "Pendekeza mgonjwa apate vipimo vifuatavyo",
				supply_ors_text:
					"Tafadhali mpatie mgonjwa Oral Rehydration Salts (ORS)",
				supply_ors_button: "Bonyeza kuongeza ORS",
			},
			recommendations: {
				title: "Mapendekezo mengine",
				refered_nearest_facilty_text:
					"Mrejeshe kituo cha afya cha karibu",
				...
				additional_recommendations: {
					...
					placeholder:
						"Andika mapendekezo yoyote, kama yapo, uliyonayo kwa ajili ya mgonjwa",
				},
			},
		},
		components: {
