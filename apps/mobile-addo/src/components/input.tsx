...
export function VariableTextInput <T>({ 
    ...
    return (
        ...
        >
            ...
            />
            <Picker
                style={[{ flex: 0.6, backgroundColor: '#ccc', borderRadius: 100 }, fontStyle.normal, pickerStyle]}
...
export function MultiInput <T extends string>({ title, fields, configuration = {}, initialValue = {}, onChangeValue, optionsText = "Options to show", ...props }: MultiInputProps<T>) {
                        ...
                        fields
                            ...
                            .map(({ label, name, component: Component }, ix) => (
                                <View 
                                    ...
                                    <Component value={data[name]} onChangeValue={onChangeComponentValue(name)} />
                                </View>
                            ))
                    }
                </View>
