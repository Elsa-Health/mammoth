...
function AssessmentRecordItem({
  ...
  const ageString = React.useMemo(
    () => properAgeString(ar.assessmentInfo.age),
    [ar],
  );
    ...
    <TouchableHighlight
      ...
      <React.Fragment>
        ...
        <View style={{flex: 1}}>
          <View style={{marginVertical: 8}}>
            <Text>
              {ar.assessmentInfo.sex === 'male' ? 'Male' : 'Female'},{' '}
              {ageString}
            </Text>
            <RevealContent
          ...
          <View
            ...
            <RevealContent
              show={
                ar.diagnosis.elsa !== undefined && ar.diagnosis.elsa.length > 0
              }
      ...
      <View style={{flex: 1}}>
        <FlatList
          ...
          renderItem={({item, separators}) => (
            <AssessmentRecordItem {...item} separators={separators} />
          )}
        />
      </View>
      <View
        ...
        <Button
          ...
          style={{alignSelf: 'flex-start', borderRadius: 50, marginVertical: 5}}
          type="secondary"
          onPress={() => {
