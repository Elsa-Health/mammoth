  ...
  assessment: {
    ...
    feedback: {
      ...
      next_steps: {
        ...
        supply_ors_text:
          'Tafadhali mpatie mgonjwa Oral Rehydration Salts (ORS) na Zinc',
        supply_ors_button: 'Bonyeza kuongeza ORS na Zinc',
        supply_amoxicilin_text: 'Tafadhali mpatie mgonjwa Amoxicilin',
        supply_amoxicilin_button: 'Bonyeza kuongeza Amoxicilin',
      },
      recommendations: {
