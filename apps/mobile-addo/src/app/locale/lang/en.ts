...
export default {
  ...
  home: {
    ...
    new_assessment: {
      ...
      description:
        'To start a new assessment, please click on the button below',
  ...
  settings: {
    ...
    language: {
      ...
      description:
        "Select the language that you'd like to take effect across the entire application",
      action: 'Apply language',
    },
    choose_language: {
      title: 'Choose Language',
      description:
        "Choose the language that you'd like to take effect across the entire application",
    },
    logout: {
      title: 'Logout',
  ...
  assessment: {
    ...
    intake: {
      ...
      description: 'Enter patient details needed for symptoms assessments',
    ...
    summary: {
      ...
      elsa_diagnosis: {
        title: "Elsa's conditions to consider",
      ...
      discard_dialog: {
        ...
        description:
          'Are you sure you want to discard the current symptom assessment?',
        action: 'Discard',
      },
    },
    search: {
      ...
      search_notice:
        "Begin typing below or selecting Elsa's suggestions to find signs or symptoms",
      select_item:
        'Press on an item to specify information on the sign or symptom',
    },
    manage: {
      ...
      no_symptoms: {
        ...
        description:
          'Tap on the search box above to get started with searching for presented and absent symptoms',
      },
    },
    feedback: {
      err: {
        text_make_selection:
          'Make sure you first select the condition of choice',
      },
      title: 'Assessment Feedback',
      condition_decision: {
        title: 'Condition Decision',
        description:
          'Based on your knowledge and assessment, what is you opinion of the underlying condition causing the patients symptoms',
        component: {
      ...
      next_steps: {
        title: 'Next Steps',
        description:
          'Based on the most likely condition above, you should consider the following recommendations.',
        dispense_meds: 'Dispense the following medication',
        recommend_tests: 'Recommend the patient gets the following tests',
        supply_ors_text:
          'Please make sure to supply patient with Oral Rehydration Salts (ORS) and Zinc',
        supply_ors_button: 'Tap to Include ORS and Zinc',
        supply_amoxicilin_text: 'Please supply the patient with Amoxicilin',
        supply_amoxicilin_button: 'Tap to Include Amoxicilin',
      },
      recommendations: {
