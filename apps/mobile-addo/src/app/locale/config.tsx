...
i18n.init({
    ...
    fallbackLng: 'en',
    resources: {
      en: { translation: en, 'donpar-map': data.donparMap.translate('en'), symptoms: data.symptomsLocale.translate('en') },
      sw: { translation: sw, 'donpar-map': data.donparMap.translate('sw'), symptoms: data.symptomsLocale.translate('sw') },
    },
...
export const useTranslation = () => usei18nTranslation(undefined, { useSuspense: false })
export const LanguageProvider = ({ options, children }: { options?: InitOptions, children: React.ReactNode }) => {
