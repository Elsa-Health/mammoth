                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        <View style={{ paddingVertical: 12, width: '100%'}}>
                            <Text font="bold" style={{ fontSize: 20, marginBottom: 4 }}>{t`choose_language.title`}</Text>
                        ...
                        </View>
                        {
                            [
                                ...
                                <Pressable
                                    ...
                                    onPress={() => applySettings(x => ({ lang: s.value as 'en' | 'sw' }))} 
                                    style={[{ borderWidth: 2, borderRadius: 10, paddingHorizontal: 16, paddingVertical: 6, borderColor: theme.color.primary.base }, { justifyContent: 'center', width: '100%', marginBottom: 5, }]}
                                >
                                    <Text font="bold" style={{ color: theme.color.primary.dark }}>{s.name}</Text>
                                </Pressable>
                            ))
                        }
                    </View>
...
function MainAppInteraction () {
    const isLangNotChosen = useApplication(s => s.settings.lang === undefined, shallow)
