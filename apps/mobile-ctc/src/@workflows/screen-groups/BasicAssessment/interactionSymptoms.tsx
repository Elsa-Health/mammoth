...
export const ModalComponent = ({lang}: {lang: Language}) => {
  ...
  /** RENDER COMPONENTS **/
  const removeSymptomFromId = useSymptomAssessment(s => s.removeSymptomFromId);
      ...
      <View
        ...
        <RevealContent
          ...
          <Pressable
            ...
            <Text
              font="medium"
              style={{color: '#FFF', marginLeft: 8}}>{tc`delete`}</Text>
          </Pressable>
        </RevealContent>
        <View
          style={{
...
function DonparItemOption({
  ...
  return (
    <View style={{marginBottom: 4}}>
      <View>
        <Text font="medium" style={{textTransform: 'capitalize', fontSize: 16}}>
