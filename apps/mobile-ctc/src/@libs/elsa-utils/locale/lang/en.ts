...
export default {
	...
	assessment: {
		...
		intake: {
			...
			footer_note:
				"Tap on '$t(common.next)' go to the symptom assessment",
		...
		summary: {
			signs_summary: {
				...
				no_symptoms_more:
					"Tap on the button below to add a symptom or sign",
			},
			elsa_diagnosis: {
		...
		manage: {
			...
			no_symptoms: {
				...
				description:
					"Tap on the search box above, or choose from the list below to get started",
			},
		},
		feedback: {
			err: {
			...
			next_steps: {
				...
				recommend_tests:
					"Recommend the patient gets the following tests",
				supply_ors_text:
