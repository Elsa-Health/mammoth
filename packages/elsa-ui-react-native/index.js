...
function Pressable3(_a) {
  var _b = _a, { ripple_color } = _b, props = __objRest(_b, ["ripple_color"]);
  return /* @__PURE__ */ import_react4.default.createElement(import_react_native4.Pressable, __spreadProps(__spreadValues({
    android_ripple: {
...
var pressableStyle = import_react_native4.StyleSheet.create({
  container: {
    display: "flex",
    flexDirection: "row",
    alignItems: "center",
