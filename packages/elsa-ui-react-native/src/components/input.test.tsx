...
describe('MultiInput', () => {
  it('Renders correctly', () => {
    const HouseComponent = jest.fn().mockImplementation((_props) => {
      return <View />;
    });
    render(
      <MultiInput
  ...
  it('Sub Component', () => {
    ...
    const HouseComponent = jest
      .fn()
      .mockImplementation(({ component: Component, value, onChangeValue }) => {
        return <Component value={value} onChangeValue={onChangeValue} />;
      });
