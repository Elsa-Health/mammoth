...
declare namespace Store {
    ...
    type BuildConfig<StoreOptions> = {
        collectionDocument: (collName: string) => (documentName: string) => DocumentAction;
        collection: (name: string, documentAction: (name: string) => DocumentAction) => CollectionActions<StoreOptions, DocumentAction>;
    ...
    type CollectionActions<StoreOptions, DA extends DocumentAction> = {
        ...
        queryDoc: <T extends ProperDocumentData>(queryOptions?: QueryFilter | undefined) => Promise<T | null>;
        doc: (name: string) => DA;
        docs: () => Promise<Array<{
            docId: string;
        } & DA>>;
