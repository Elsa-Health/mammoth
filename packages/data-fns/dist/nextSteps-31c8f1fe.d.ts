...
import { LabTest, Medication } from './recommended';
...
declare function basic<C extends Condition, M extends _AllMedications, L extends string>(conditionsFn: () => C[], medicationsFn: () => M[], labTestsFn: () => L[]): { [id in C]: NextSteps.Basic<M, L>; };
declare function extended<C extends Condition, M extends _AllMedications, L extends LabTest>(conditionsFn: () => C[], medicationsFn: () => M[], labTestsFn: () => L[]): {
    all: { [id in C]: NextSteps.Extended<M, L>; };
    locale: (lang: Langugage) => { [id_1 in C]: NextSteps.Basic<M, L> & NextSteps.ExtendedVals<M, L>; };
};

declare const nextSteps_NextSteps: typeof NextSteps;
declare const nextSteps_basic: typeof basic;
declare const nextSteps_extended: typeof extended;
declare namespace nextSteps {
  export {
    nextSteps_NextSteps as NextSteps,
    nextSteps_basic as basic,
    nextSteps_extended as extended,
  };
}

export { NextSteps as N, basic as b, extended as e, nextSteps as n };
